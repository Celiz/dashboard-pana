...
import { Store, Receipt, TrendingUp, DollarSign } from "lucide-react"
...
export function DashboardClient({ locales, tickets }: DashboardClientProps) {
  // Cálculos derivados
  const stats = useMemo(() => {
    let totalRevenue = 0
    let totalItems = 0
                  ...
                  <div className="flex items-center space-x-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1.5">
                        WP: {local.telefonos.map(t => "+" + t).join(", ") || "Sin números"}
                      </p>
                    </div>
                  </div>
